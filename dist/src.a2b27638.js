 ...
 */
function initPage() {
  var t = (0, _jquery.default)("#arena"),
    e = (0, _jquery.default)("#player"),
    s = (0, _jquery.default)("#computer"),
    h = (0, _jquery.default)("#ball"),
    r = (0, _jquery.default)("#user-score"),
    n = (0, _jquery.default)("#computer-score"),
    l = (0, _jquery.default)("#gameover");
  ...
  var Ball = function Ball(i) {
     ...
     */
    this.edges = function () {
      (this.y < 0 || this.y > t.innerHeight() - this.radius) && (this.velocityY *= -1);
    };
   ...
   */
  var Computer = function Computer(i) {
   ...
   */
  var CollisionDetector = function CollisionDetector(ball, player) {
    this.ball = ball;
    this.player = player;
   ...
   */
  var checkGameEnd = function checkGameEnd(player, computer) {
    var winner = "";
    if (player.score === 3 || computer.score === 3) {
      winner = player.score === 3 ? "player" : "computer";
      clearInterval(f);
      (0, _jquery.default)(document).off();
      e.hide();
      s.hide();
      l.css({
        display: "flex"
  ...
  var f = setInterval(function () {
    ...
    var paddleToCheck = player.x < t.innerWidth() / 2 ? computer : player;

    // Check for collision and update ball velocity
    if (new CollisionDetector(ball, paddleToCheck).check()) {
      var distanceFromCenter = ball.y - (player.y + e.innerHeight() / 2);
      var angle = Math.PI / 4 * (distanceFromCenter /= e.innerHeight() / 2);
      var direction = player.x < t.innerWidth() / 2 ? 1 : -1;
...
(0, _jquery.default)(initPage);
},{"jquery":"node_modules/jquery/dist/jquery.js","./styles.css":"src/styles.css"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "42581" + '/');
